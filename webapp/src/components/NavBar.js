                                ...
                                <div className="main_nav_content d-flex flex-row">
                                    ...
                                    <div className="cat_menu_container">
                                        ...
                                        {/*<ul className="cat_menu">
                                            <li><a href="#">Desktops & All-In-Ones <i className="fas fa-chevron-right ml-auto"></i></a></li>
                                            <li><a href="#">2-in-1s<i className="fas fa-chevron-right"></i></a></li>
                                            <li><a href="#">Laptops<i className="fas fa-chevron-right"></i></a></li>
                                            <li><a href="#">PC & Tablet accessories<i className="fas fa-chevron-right"></i></a></li>
                                            <li><a href="#">Monitors<i className="fas fa-chevron-right"></i></a></li>
                                            
                                            <li><a href="#">Electronics and Accessories<i className="fas fa-chevron-right"></i></a></li>
                                            <li><a href="#">Replacement Parts and Upgrades<i className="fas fa-chevron-right"></i></a></li>
                                    ...
                                    <div className="main_nav_menu ml-auto">
                                        <ul className="standard_dropdown main_nav_dropdown">
                                            ...
                                            <li className="hassubs">
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="#">TJ Exclusives<i className="fas fa-chevron-down"></i></a>
                                                        <ul>
                                                            <li><a href="#">Dynaudio<i className="fas fa-chevron-down"></i></a></li>
                                                            <li><a href="#">Microsoft<i className="fas fa-chevron-down"></i></a></li>
                                                            <li><a href="#">Yamaha<i className="fas fa-chevron-down"></i></a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="#">Xiaomi<i className="fas fa-chevron-down"></i></a></li>
                                                    <li><a href="#">Acer<i className="fas fa-chevron-down"></i></a></li>
                                                    <li><a href="#">Boat<i className="fas fa-chevron-down"></i></a></li>
                                                </ul>
                                            </li>
                                            <li className="hassubs">
                                                <a href="#">Sitemap<i className="fas fa-chevron-down"></i></a>
                                                <ul>
                                            ...
                                            <li><a href="contact.html">Contact Us<i className="fas fa-chevron-down"></i></a></li>
                                        </ul>
                                    </div>
